...
class CreateVariantDriversTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('variant_drivers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('variant_drivers');
    }
}
